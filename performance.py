...
def display_performance_history():
    ...
    # --- SÉLECTION DE PÉRIODE PAR BOUTONS STYLISÉS COMME DU TEXTE ---
    ...
    st.markdown("""
        ...
        .period-buttons-container {
            ...
            margin-bottom: 1rem;
            /* width: fit-content; */ /* La largeur s'adapte au contenu des boutons */
            /* Si vous voulez une largeur fixe, par exemple: width: 400px; */
            /* Streamlit peut parfois ajouter des conteneurs qui limitent la largeur,
               mais ce style est appliqué directement au div que nous créons. */
        }
    ...
    # Le style width: fit-content est appliqué ici directement dans la balise div
    st.markdown('<div class="period-buttons-container" style="width: fit-content;">', unsafe_allow_html=True)
    
    # Générer les boutons stylisés comme du texte, sans utiliser st.columns
