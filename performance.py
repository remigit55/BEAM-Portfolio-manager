...
def display_performance_history():
    ...
    # --- SÉLECTION DE PÉRIODE PAR SPAN CLIQUABLES ---
    ...
    st.markdown('<div class="outer-period-container"><div class="period-span-container">', unsafe_allow_html=True)
