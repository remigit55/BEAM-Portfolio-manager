...
def display_performance_history():
    ...
    for label in period_options:
        ...
        # Utilise un sélecteur plus robuste pour cibler le bouton Streamlit par son data-testid
        # Le '?' après querySelector permet de ne pas générer d'erreur si l'élément n'est pas encore là
        if is_selected:
            st.markdown(f"""
                <script>
