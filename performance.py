...
def display_performance_history():
    ...
    # Pour un espacement précis de 5px à gauche, il faudrait injecter du CSS ciblant les boutons.
    # Ici, les colonnes Streamlit gèrent l'espacement, mais pas à un pixel près.
